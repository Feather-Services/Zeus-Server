package fr.featherservices.zeus.license;
...
public class License {
    ...
    private String requestKey = "vmLAyzmppLLDgvqMPFyHLSkWdyHYqRImNueC1OLK457896";
    ...
    public License(String license, String server) {
    ...
    public void request() {
        try {
            ...
            connection.setRequestProperty("Plugin-Name", "ZeusServer");
